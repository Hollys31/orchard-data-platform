<template>
    <div class="talk">
        <div class="talk-button" @click="showInfo = !showInfo" :style="talking ? 'background-position: 0 -75px;' : 'background-position: 0 0;'">
...
export default {
    ...
    methods: {
        startTalk () {
            ...
            const bizParams = {
                id: 'ezui-talk',
                token: 'at.8opcdwtscfa01bse2bwggj5l8wr7ht0w-2h66dc40h7-0pah5gu-iqv4t9fqj',
                uuid: '62e88b123fe94e0f8972485c5f5aead6'
            }
            that.talk = new EZUIKit.EZUITalk(bizParams)
        }
    }
}
</script>
